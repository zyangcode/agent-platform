...
const defaultDictionary: TranslationDictionary = {
  ...
  'runtime.teamAfterDependency': { en: 'after {dependency}', zh: '依赖 {dependency}' },
  'runtime.teamEventCount': { en: '{count} events', zh: '{count} 个事件' },
  'runtime.teamGoal': { en: 'Goal', zh: '目标' },
  'runtime.teamReviewCompleted': { en: 'Review completed.', zh: '审查已完成。' },
  'runtime.teamReviewNeedsRetry': { en: 'needs retry', zh: '需要重试' },
  'runtime.teamReviewPassed': { en: 'passed', zh: '已通过' },
  'runtime.teamReviewer': { en: 'Reviewer', zh: '审查员' },
  'runtime.teamRun': { en: 'Team run', zh: 'Team 运行' },
  'runtime.teamRunDescription': {
    en: 'Planner, Executor, Reviewer progress.',
    zh: 'Planner、Executor、Reviewer 的阶段进度。',
  },
  'runtime.teamStatusPending': { en: 'pending', zh: '待执行' },
  'runtime.teamStatusSkipped': { en: 'skipped', zh: '已跳过' },
  'runtime.teamWaitingForPlan': { en: 'Waiting for plan', zh: '等待计划' },
  'runtime.teamWaitingForPlanDescription': {
    en: 'Team events have started, but no task plan has arrived yet.',
    zh: 'Team 事件已开始，但任务计划还没有到达。',
  },
