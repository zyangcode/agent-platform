...
const defaultDictionary: TranslationDictionary = {
  ...
  'chat.teamMode': { en: 'Team', zh: '多 Agent 模式' },
  ...
  'runtime.confirmTool': { en: 'Confirm tool', zh: '确认工具' },
  ...
  'runtime.eventTimelineDescription': {
    en: 'thinking, action, observation, tool_confirm_required, message_delta, message, done, error.',
  ...
  'tools.intro': {
    en: 'Manage executable Skills, experience Skills, MCP servers, and MCP tools available to Agent Profiles.',
    zh: '浏览可绑定到 Profile 的已有 Skill 和 MCP 工具。阶段 3 暂不包含上传和 Jar 热加载界面。',
  },
  'tools.applicationRequired': { en: 'Select an application first.', zh: '请先选择应用。' },
  'tools.code': { en: 'Code', zh: '编码' },
  'tools.connectionConfig': { en: 'Connection config JSON', zh: '连接配置 JSON' },
  'tools.content': { en: 'Content', zh: '内容' },
  'tools.createExperienceSkill': { en: 'Create experience Skill', zh: '创建经验型 Skill' },
  'tools.createExperienceSkillDescription': {
    en: 'Experience Skills inject reusable domain rules into context. They are not executable tools.',
    zh: '经验型 Skill 会作为领域经验注入上下文，不作为可执行工具调用。',
  },
  'tools.createMcpServer': { en: 'Create MCP server', zh: '创建 MCP Server' },
  'tools.createMcpServerDescription': {
    en: 'Register an external MCP server process or endpoint. Tools discovered for the server can later be bound to Profiles.',
    zh: '注册外部 MCP 进程或端点；该服务下的工具后续可绑定到 Profile。',
  },
  'tools.domain': { en: 'Domain', zh: '领域' },
  'tools.executableSkills': { en: 'Executable Skills', zh: '工具型 Skill' },
  'tools.experienceCreateFailed': { en: 'Experience Skill could not be created.', zh: '经验型 Skill 创建失败。' },
  'tools.experienceCreateSuccess': { en: 'Experience Skill created.', zh: '经验型 Skill 已创建。' },
  'tools.experienceDisableFailed': { en: 'Experience Skill could not be disabled.', zh: '经验型 Skill 禁用失败。' },
  'tools.experienceDisableSuccess': { en: 'Experience Skill disabled.', zh: '经验型 Skill 已禁用。' },
  'tools.experienceSkills': { en: 'Experience Skills', zh: '经验型 Skill' },
  'tools.externalProtocol': { en: 'External protocol', zh: '外部协议' },
  'tools.jarFile': { en: 'Jar file', zh: 'Jar 文件' },
  'tools.jarRequired': { en: 'Select a Jar file before uploading.', zh: '上传前请选择 Jar 文件。' },
  'tools.knowledgeBase': { en: 'Knowledge base', zh: '知识库 RAG' },
  'tools.longTermMemory': { en: 'Long-term memory', zh: '长期记忆' },
  'tools.loadFailed': { en: 'Tools could not be loaded.', zh: '工具数据加载失败。' },
  'tools.manifestJson': { en: 'Manifest JSON', zh: 'Manifest JSON' },
  'tools.memoryCategory': { en: 'Category', zh: '记忆分类' },
  'tools.memoryDisableFailed': { en: 'Memory could not be disabled.', zh: '记忆禁用失败。' },
  'tools.memoryDisableSuccess': { en: 'Memory disabled.', zh: '记忆已禁用。' },
  'tools.memoryFiltersDescription': {
    en: 'Inspect persisted memories before they are injected into runtime context slots.',
    zh: '检查已持久化的长期记忆，确认它们进入运行时上下文前的状态。',
  },
  'tools.memoryFiltersTitle': { en: 'Memory filters', zh: '记忆筛选' },
  'tools.memoryImportance': { en: 'Importance', zh: '重要性' },
  'tools.memoryLimit': { en: 'Limit', zh: '数量上限' },
  'tools.memoryLoadFailed': { en: 'Memories could not be loaded.', zh: '记忆加载失败。' },
  'tools.memoryLoadSuccess': { en: 'Loaded {count} memories.', zh: '已加载 {count} 条记忆。' },
  'tools.memoryNoResults': { en: 'No memories', zh: '暂无记忆' },
  'tools.memoryNoResultsDescription': {
    en: 'Run chat with READ_WRITE memory or adjust filters to inspect persisted records.',
    zh: '先使用 READ_WRITE 记忆策略对话，或调整筛选条件查看已有记录。',
  },
  'tools.memoryQuery': { en: 'Query', zh: '检索关键词' },
  'tools.memoryRecords': { en: 'Memory records', zh: '记忆记录' },
  'tools.memoryRecordsDescription': { en: '{count} records in the current result set.', zh: '当前结果集中有 {count} 条记录。' },
  'tools.memorySearch': { en: 'Search memories', zh: '检索记忆' },
  'tools.memorySlotHint': { en: 'Slot hint', zh: 'Slot 提示' },
  'tools.memoryTags': { en: 'Tags', zh: '标签' },
  'tools.memoryUpdateFailed': { en: 'Memory could not be updated.', zh: '记忆更新失败。' },
  'tools.memoryUpdateSuccess': { en: 'Memory updated.', zh: '记忆已更新。' },
  'tools.mcp': { en: 'MCP', zh: 'MCP' },
  'tools.mcpServerCreateFailed': { en: 'MCP server could not be created.', zh: 'MCP Server 创建失败。' },
  ...
  'tools.noDomain': { en: 'No domain', zh: '未设置领域' },
  'tools.noExperienceSkills': { en: 'No experience Skills', zh: '暂无经验型 Skill' },
  'tools.noExperienceSkillsDescription': {
    en: 'Select an application and create experience rules for context recall.',
    zh: '请选择应用，并创建可用于上下文召回的经验规则。',
  },
  'tools.noMcpServers': { en: 'No MCP servers', zh: '暂无 MCP Server' },
  'tools.noMcpServersDescription': {
    en: 'Create an MCP server before binding external tools to Profiles.',
    zh: '绑定外部工具前，请先创建 MCP Server。',
  },
  ...
  'tools.ragDeleteFailed': { en: 'RAG document could not be deleted.', zh: 'RAG 文档删除失败。' },
  'tools.ragDeleteSuccess': { en: 'RAG document deleted.', zh: 'RAG 文档已删除。' },
  'tools.ragIngest': { en: 'Ingest document', zh: '写入知识库' },
  'tools.ragIngestDescription': {
    en: 'Create a scoped knowledge document for RAG recall. The backend splits, embeds when enabled, and falls back to keyword search.',
    zh: '创建带作用域的知识文档；后端会切分、按配置写向量，并在不可用时降级关键词检索。',
  },
  'tools.ragIngestFailed': { en: 'RAG document ingest failed.', zh: 'RAG 文档写入失败。' },
  'tools.ragIngestSuccess': {
    en: 'RAG document {documentId} indexed with {chunkCount} chunks.',
    zh: 'RAG 文档 {documentId} 已索引，生成 {chunkCount} 个 chunk。',
  },
  'tools.ragIngestTitle': { en: 'Document ingest', zh: '文档入库' },
  'tools.ragNoResults': { en: 'No RAG results', zh: '暂无 RAG 结果' },
  'tools.ragNoResultsDescription': {
    en: 'Ingest a document, then search with a phrase that should appear in the knowledge base.',
    zh: '先写入文档，再用知识库中应命中的短语检索。',
  },
  'tools.ragOverlap': { en: 'Overlap tokens', zh: '重叠 Token' },
  'tools.ragQuery': { en: 'Query', zh: '检索问题' },
  'tools.ragSearch': { en: 'Search RAG', zh: '检索 RAG' },
  'tools.ragSearchDescription': {
    en: 'Manually verify retrieved chunks before checking how the Agent injects them into context.',
    zh: '先手工验证召回 chunk，再检查 Agent 如何把它们注入上下文。',
  },
  'tools.ragSearchFailed': { en: 'RAG search failed.', zh: 'RAG 检索失败。' },
  'tools.ragSearchSuccess': { en: 'RAG search returned {count} results.', zh: 'RAG 检索返回 {count} 条结果。' },
  'tools.ragSearchTitle': { en: 'Manual search', zh: '手工检索' },
  'tools.ragSourceType': { en: 'Source type', zh: '来源类型' },
  'tools.ragSourceUri': { en: 'Source URI', zh: '来源 URI' },
  'tools.ragTitle': { en: 'Document title', zh: '文档标题' },
  'tools.ragTopK': { en: 'Top K', zh: 'Top K' },
  ...
  'tools.uploadJarSkillDescription': {
    en: 'Register an executable Skill from a Jar and manifest. The backend validates and records the artifact.',
    zh: '通过 Jar 和 manifest 注册可执行 Skill；后端会校验并记录制品。',
  },
  'tools.uploadSuccess': { en: 'Jar Skill uploaded.', zh: 'Jar Skill 已上传。' },
  'tools.visibleLoadedMcp': {
    en: '{visible} visible of {total} loaded MCP tools.',
    zh: '已加载 {total} 个 MCP 工具，当前显示 {visible} 个。',
  },
  'tools.visibleLoadedExperience': {
    en: '{visible} visible of {total} loaded experience Skills.',
    zh: '已加载 {total} 个经验型 Skill，当前显示 {visible} 个。',
  },
  'tools.visibleLoadedMcpServers': {
    en: '{visible} visible of {total} loaded MCP servers.',
    zh: '已加载 {total} 个 MCP Server，当前显示 {visible} 个。',
  },
  ...
  'profile.memoryDisabled': { en: 'Disabled', zh: '关闭' },
  'profile.memoryMode': { en: 'Memory strategy', zh: '记忆策略' },
  'profile.memoryReadOnly': { en: 'Read only', zh: '只读' },
  'profile.memoryReadWrite': { en: 'Read & Write', zh: '读写' },
  'profile.memorySessionOnly': { en: 'Session only', zh: '仅会话' },
  ...
  'profile.toolBindingsDescription': {
    en: 'Bind executable Skills and MCP tools managed from the Tools page.',
  ...
  'trace.estimatedRatio': { en: 'Estimated ratio', zh: '估算占比' },
  'trace.modelCallCount': { en: 'Model calls', zh: '模型调用次数' },
  'trace.modelName': { en: 'Model', zh: '模型' },
  'trace.modelTokenUsage': { en: 'Model token usage', zh: '模型 Token 用量' },
  'trace.modelTotalTokens': { en: 'Model tokens', zh: '模型总 Token' },
  ...
  'trace.promptTokens': { en: 'Prompt tokens', zh: '输入 Token' },
  'trace.providerType': { en: 'Provider', zh: '供应商' },
  ...
  'trace.slowestModelCall': { en: 'Slowest model call', zh: '最慢模型调用' },
  ...
  'trace.totalTokens': { en: 'Total tokens', zh: '总 Token' },
  ...
  'trace.usageSource': { en: 'Usage source', zh: '用量来源' },
